...
def deploy():
    ...
    payload = json.dumps({
        "name": sanitize_name("Health-Policy-Agent"),
        "description": """A Health Policy agent that can search our knowledge base, Provide a Health Policy related information""",
        "definition": {
            "kind": "prompt",
            "model": "gpt-4o",
            "instructions": """A Health Policy agent that can search our knowledge base, Provide a Health Policy related information"""
        }
    }).encode()
